...
description: Many experts have expresses their opinion on an issue that mixes economics, political and philospical aspects that go back to the conception of nationalism that was developed with the birth of the modern states. Retrospectively, I looked at a model to predict the brexit vote. 
draft: false
image: brexit.jpeg
keywords: ""
slug: brexit_vote
...
brexit_results <- read_csv("/Users/guidobassi/Desktop/website/content/blogs/brexit_results.csv")
